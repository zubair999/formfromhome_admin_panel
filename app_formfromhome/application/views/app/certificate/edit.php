<div class="container p-0">
  <?php echo form_open_multipart('edit-certificate/'.$certificate_id, array('method'=>'post')); ?>
<div class="row mt">
            ...
            <div class="row clearfix">
              ...
              <div class="col-xs-12">
                 ...
                 <div class="form-group">
                   <div class="input-group full_width">
                    <input  type="text" name="certificate_name"  value="<?php echo ($this->input->post('certificate_name') ? $this->input->post('certificate_name') : $certificate_obj->certificate_name )  ?>" class="form-control pull-right transform_01"  required/>
                 </div>
              ...
              <div class="col-xs-12">
                  <div class="form-group text-danger">
                    <img src="<?= base_url('uploads/certificates/'.$certificate_obj->certificate_img); ?>" style="width:100px;height:100px;">
                  </div>
               </div>
...
<div class="row mb">
  <div class="box-footer">
     <input type="submit" name="submit1" class="btn btn-warning" value="Updates Details">
  </div>
</div>
