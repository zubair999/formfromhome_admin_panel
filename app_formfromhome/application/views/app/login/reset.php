...
<head>
	...
	<title>Form From Home App Login</title>
...
<body>
	...
	<div class="ln_1i">
		<div>
			...
			<?php echo form_open('confirm', array('method'=>'post')); ?>
			<div>
				<input type="hidden" name="mobileno" value="<?= $mobileno ?>">
			</div>
			<div>
				<input type="text" name="otp" placeholder="Enter OTP Recieved">
				<span class="txt-danger kl_w2"><?= form_error('otp') ?></span>
			</div>
			<div>
				<input type="password" name="newpass" placeholder="Enter New Password">
				<span class="txt-danger kl_w2"><?= form_error('newpass') ?></span>
			</div>
			<div>
	...
	<div class="frgeCtn">
		<div>
			<a class="btn" href="<?= base_url('forget-password'); ?>">Back</a>				
		</div>
	</div>
