...
<body>
	...
	<div class="ln_1i">
		<div>
			...
			<?php echo form_open('app-login', array('method'=>'post')); ?>
			<div>
				<input type="email" name="loginid" placeholder="Login ID">
	...
	<div class="frgeCtn">
		<div>
			<a class="btn" href="<?= base_url('forget-password'); ?>">Forget Password</a>				
		</div>
	</div>
